#!/usr/bin/env python3
"""Compatibility shim for the captured-source authoritative test runner.

The machine report is emitted by captured ``atomic_write_json`` project code;
this shim never places project paths on ``sys.path`` or imports project code.
"""
